      ...
      <main>
        ...
        <div ref={infoSection}>
          ...
          <InfoSection
            ...
            content={
              "At Sonicbeats, our commitment to sustainability is woven into every aspect of our design and production processes. We believe that creating exceptional audio experiences should go hand-in-hand with preserving the environment. Our dedication to eco-friendly practices begins with our use of recycled oak wood, carefully selected and repurposed from floor boards is to reduce waste and minimize our ecological footprint. We are constantly innovating to find new ways to enhance the sustainability of our products. From employing energy-efficient manufacturing techniques to choosing sustainable materials, every step of our process reflects our dedication to environmental stewardship. Our speakers are designed not only to deliver superior sound but also to contribute positively to the planet. By integrating cutting-edge technology with sustainable practices, we ensure that each Sonicbeats product is a testament to our commitment to both quality and the environment."
            }
          />
        </div>
        <ImageCarousel />

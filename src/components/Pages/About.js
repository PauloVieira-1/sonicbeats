      ...
      <main>
        <div className="my-5" style={{ zIndex: "100" }}>
          <InfoSection
            ...
            content={
              "At Artisan Sound, we believe that great sound should come with a great story. Our journey began with a passion for music and a commitment to sustainability. Each of our bespoke speakers is crafted from the finest materials, including our signature recycled Eik wood, ensuring not only exceptional sound quality but also a positive impact on the environment."
            }
            shadow={true}
            image={VerticalImage}
            button={true}
        ...
        <div ref={infoSection}>
          ...
          <InfoSection
            ...
            content={
              "Our team is a diverse group of audio engineers, designers, and craftsmen, all united by a shared love of music and dedication to quality. Meet the people behind the sound and discover the passion and expertise that go into every Artisan Sound speaker."
            }
          />
        </div>
        <ImageCarousel />
